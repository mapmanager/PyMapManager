...
def run():
    ...
    if 1:
        plotdict = newplotdict()
        plotdict['xstat'] = 'days'
        plotdict['ystat'] = 'index'  #'pDist' # position of spine on its parent segment
        plotdict['plotbad'] = True
        plotdict = _map.getMapValues3(plotdict)
        
        # display with matplotlib
        x = plotdict['x']
        y = plotdict['y']

        print('plotdict["y"]', type(plotdict['y']), plotdict['y'].shape)
        print(plotdict['y'])
