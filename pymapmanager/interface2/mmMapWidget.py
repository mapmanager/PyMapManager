...
class mmMapWidget(QtWidgets.QMainWindow):
    ...
    def openStack2(self, mmMap : pmm.mmMap, session : int) -> "pmm.interface2.stackWidget":
    ...
    def openMapTableWidget(self):
        ...
        """
        logger.info('')
        self._mapTableWidget = pmm.interface2.mmMapTable(self._map)
