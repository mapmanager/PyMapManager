...
class PixelSource:
    def __init__(self, line_segments: gp.GeoDataFrame, points: gp.GeoDataFrame):
    ...
    def getLayers(self, options):
        with warnings.catch_warnings():
            ...
            if options["showLineSegments"]:
                layers.extend(self.get_segments(options))
...
# def newPixelSource(lineAnnotationsDF, pointAnnotationsDF):
