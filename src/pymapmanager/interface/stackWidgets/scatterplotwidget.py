...
from pymapmanager.interface.core.scatter_plot_widget import ScatterPlotWidget_
from pymapmanager.interface.stackWidgets.base.mmWidget2  import mmWidget2, pmmEventType, pmmEvent
from pymapmanager.interface.stackWidgets.event.spineEvent import DeleteSpineEvent, EditSpinePropertyEvent
...
class ScatterPlotWidget(mmWidget2):
    ...
    def _buildScatterPlot(self):
        self._scatterPlotWidget = ScatterPlotWidget_(df=self.df,
                                                     filterColumn="roiType", acceptColumn = None,
    ...
    def selectedEvent(self, event : pmmEvent):
        """ StackWidget emits signal to this widget.
        
        This function passes those point selections into the stand alone
