...
from pymapmanager.interface.stackWidgets.base.mmWidget2 import (
    mmWidget2, pmmEvent, pmmEventType)
from pymapmanager.interface.stackWidgets.event.segmentEvent import _EditSegment
from pymapmanager.interface.stackWidgets.event.spineEvent import _EditSpine
