...
class mmWidget2(QtWidgets.QMainWindow):
    ...
    def __init__(self,
                 stackWidget : "pymapmanager.interface.stackWidgets.StackWidget2" = None,
                 mapWidget : "pymapmanager.interface.mapWidgets.mapWidget" = None,
    ...
    def getFileName(self) -> str:
        return self.getStack().getFileName()
    ...
    def setStackWidget(self, stackWidget) -> stackWidget: # abj
