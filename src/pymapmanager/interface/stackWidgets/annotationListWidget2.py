...
from pymapmanager.interface.core._data_model import pandasModel
...
class annotationListWidget(mmWidget2):
    ...
    def __init__(self,
                    ...
                    annotations : "pymapmanager.annotations.AnnotationsCore",
                    name : str = None):
        """
        Args:
            annotations:
        ...
        self._annotations : "pymapmanager.annotations.AnnotationsCore" = annotations
    ...
    def _initToolbar(self) -> QtWidgets.QVBoxLayout:
        ...
        # from pymapmanager.interface.stackWidgets import TracingWidget
...
class lineListWidget(annotationListWidget):
    ...
    def _initToolbar(self) -> QtWidgets.QVBoxLayout:
        ...
        from pymapmanager.interface.stackWidgets.tracingWidget import TracingWidget
