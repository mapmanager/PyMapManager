...
# import pymapmanager.interface.stackWidgets.histogramWidget2
if TYPE_CHECKING:
    from pymapmanager.interface.pyMapManagerApp import PyMapManagerApp
    from pymapmanager.interface.appDisplayOptions import AppDisplayOptions
...
class stackWidget(MainWindow):
    ...
    def __init__(self,
                    ...
                    mapWidget : "pymapmanager.interface.mapWidget.mapWidget" = None,
                    timepoint : int = 1,
    ):
        ...
        self._mapWidget : Optional["pymapmanager.interface.mapWidgets.mapWidget"] = mapWidget
