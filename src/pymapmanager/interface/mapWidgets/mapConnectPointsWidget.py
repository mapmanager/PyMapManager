...
# from pymapmanager.interface.stackWidgets.base.mmWidget2 import pmmEventType, pmmEvent
...
class mapConnectPointsWidget(MainWindow):
    ...
    def _on_table_selection(self, absRowIdx : List[int]):
        if len(absRowIdx) == 0:
            ...
            if preIsValid:
                ...
                # from pymapmanager.interface.stackWidgets.event.spineEvent import SelectSpine
    ...
    def _buildTopControls(self):
        ...
        # # explicitly turrning this off, our stackWidget can't switch timepoints!!!
    ...
    def _buildUI(self):
        ...
        # pre stack
        self.preStackWidget = stackWidget(timeseriescore=self._map,
                                           mapWidget=self,
        ...
        # post stack
        self.postStackWidget = stackWidget(timeseriescore=self._map,
                                            mapWidget=self,
