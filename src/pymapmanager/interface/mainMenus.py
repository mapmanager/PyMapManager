...
class PyMapManagerMenus:
    ...
    """
    def __init__(self, app: PyMapManagerApp):
        self._app: PyMapManagerApp = app

    def getApp(self) -> PyMapManagerApp:
        """Get the pyMapManagerApp.
        """
    ...
    def _refreshWindowsMenu(self):
        ...
        if 0:
            try:
                ...
                # abb, triggers except (AttributeError) when front window is not a stackWidget
            ...
            # when activeWindow was not a stackWidget
